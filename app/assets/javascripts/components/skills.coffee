...
#           top: 'easeInOutQuart'
#         complete: ->
#           $(this).removeClass('jquery-1').addClass 'jquery-2'
#           return
#       return
...
#           left: 'easeInOutQuart'
#         complete: ->
#           $(this).removeClass('jquery-2').addClass 'jquery-3'
#           return
#       return
...
#           left: 'easeInOutQuart'
#         complete: ->
#           $(this).removeClass('jquery-3').addClass 'jquery-4'
#           return
#       return
...
#           left: 'easeInOutQuart'
#         complete: ->
#           $(this).removeClass('jquery-4').addClass 'jquery-5'
#           return
#       return
