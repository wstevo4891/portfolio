...
RSpec.describe ExhibitsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Exhibit" do
        expect {
          post :create, {:exhibit => valid_attributes}, valid_session
        }.to change(Exhibit, :count).by(1)
      end

      it "assigns a newly created exhibit as @exhibit" do
        post :create, {:exhibit => valid_attributes}, valid_session
        expect(assigns(:exhibit)).to be_a(Exhibit)
        expect(assigns(:exhibit)).to be_persisted
      end

      it "redirects to the created exhibit" do
        post :create, {:exhibit => valid_attributes}, valid_session
        expect(response).to redirect_to(Exhibit.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved exhibit as @exhibit" do
        post :create, {:exhibit => invalid_attributes}, valid_session
        expect(assigns(:exhibit)).to be_a_new(Exhibit)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested exhibit" do
        exhibit = Exhibit.create! valid_attributes
        put :update, {:id => exhibit.to_param, :exhibit => new_attributes}, valid_session
        exhibit.reload
      ...
      it "assigns the requested exhibit as @exhibit" do
        exhibit = Exhibit.create! valid_attributes
        put :update, {:id => exhibit.to_param, :exhibit => valid_attributes}, valid_session
        expect(assigns(:exhibit)).to eq(exhibit)
      end
    ...
    context "with invalid params" do
      it "assigns the exhibit as @exhibit" do
        exhibit = Exhibit.create! valid_attributes
        put :update, {:id => exhibit.to_param, :exhibit => invalid_attributes}, valid_session
        expect(assigns(:exhibit)).to eq(exhibit)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested exhibit" do
      exhibit = Exhibit.create! valid_attributes
      expect {
        delete :destroy, {:id => exhibit.to_param}, valid_session
      }.to change(Exhibit, :count).by(-1)
    end
    ...
    it "redirects to the exhibits list" do
      exhibit = Exhibit.create! valid_attributes
      delete :destroy, {:id => exhibit.to_param}, valid_session
      expect(response).to redirect_to(exhibits_url)
    end
  end
